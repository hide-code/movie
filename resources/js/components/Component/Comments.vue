    ...
    <div class="w-4/5 mb-20 mx-auto lex-grow border-sky-500">
      ...
      <div>
        <div class="mb-6">
          ...
          <p v-if="valid.title" class="mt-2 text-sm text-red-600 dark:text-red-500">20文字以上40文字以内で入力してください。</p>
        </div>
        <div class="mb-6">
          ...
          <p v-if="valid.content" class="mt-2 text-sm text-red-600 dark:text-red-500">20文字以上200文字以内で入力してください。</p>
        </div>
...
<script>
  export default {
    ...
    methods: {
      ...
      isInValidContent() {
        return this.content.length === 0 || this.content.length > 5
      },
      post: function () {
