          ...
          <div class="flex flex-wrap -m-4">
            ...
            <div class="p-4 md:w-1/3">
              <div class="h-full border-2 border-gray-200 border-opacity-60 rounded-lg overflow-hidden">
                <a href="{{ route('content.show', ['id' => $content->id]) }}"><img class="lg:h-48 md:h-36 w-full object-cover object-center" src="{{ config('filesystems.disks.s3.url') . $content->avatar }}" alt="blog"></a>
                <div class="p-6">
